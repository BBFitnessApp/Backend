...
namespace Utils
{
    public static class MyFile
    {
        ...
        public static async Task<string[][]> ReadStringMatrixFromCsvAsync(string fileName, bool overreadTitleLine, char delimiter = ';')
        {
            ...
            {
                elements[line - subtractIndex] = lines[line].Split(delimiter);
            }
            return elements;
        }
    }
